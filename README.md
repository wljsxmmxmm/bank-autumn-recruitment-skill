...
> 从简历到 Offer，把银行秋招拆成看得清、跟得住、能复盘的一套陪跑流程。
...
`银行秋招 Skill` 是一个面向 2027 届银行秋招/校招求职者的 Codex Skill。它把职业咨询导师的判断流程沉淀成可复用工作流，覆盖从简历上传、竞争力评估、银行选择、个性化投递表、外部在线表格、笔试面试准备，到 Offer 决策的完整链路。
