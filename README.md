...
> 像一位懂银行秋招的陪跑导师，帮你把简历、投递、笔面试和 Offer 选择一件件理顺。
...
`银行秋招 Skill` 是一个面向 2027 届银行秋招/校招求职者的 Codex Skill。它把职业咨询导师的陪跑经验沉淀成可复用流程，覆盖从简历上传、竞争力评估、银行选择、个性化投递表、外部在线表格、笔试面试准备，到 Offer 决策的完整链路。

它不替用户自动投递，不编造实时招聘信息，也不把小红书、社群截图或匿名爆料当作官方结论。它的价值在于让银行秋招这件事变得更清楚、更有节奏，也更容易复盘。

## 我们怎么包装它

如果把它介绍给学生，它不是“一个表格工具”，而是一个懂银行秋招节奏的陪跑助手：
...
```text
把银行秋招从“到处搜信息、焦虑海投”，变成“先判断适合什么，再有节奏地投、准备、复盘和选择”。
```
...
| 背书角度 | 可用表达 |
|---|---|
| 银行 HR 视角 | 不只看简历漂不漂亮，而是按银行网申筛选逻辑判断匹配度 |
| 秋招节奏感 | 知道什么时候该投、什么时候该准备笔试、什么时候该追进度 |
| 咨询陪跑感 | 不是给一堆泛泛建议，而是根据用户背景拆主攻、重点和冲刺机会 |
| 流程敏感度 | 把公告、网申、测评、笔试、面试、体检、签约都放进同一条线里管理 |
| 选择判断力 | 拿到 Offer 后继续看岗位真实内容、机构层级、薪酬结构和长期发展 |

更像小红书口吻的短文案：

```text
适合想投银行、但不知道该怎么选银行和岗位的同学。
它会先按银行 HR 的视角看你的简历，再帮你拆主攻、重点和冲刺机会；
投递之后继续跟截止、跟通知、跟复盘，直到笔面试和 Offer 选择。
```
